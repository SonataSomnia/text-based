tyrano.plugin.kag = {
  ...
  stat: {
    ...
    current_page: "fore",
    simultaneous_layer: "message1",
    simultaneous_page: "fore",
    dual_message:0,
    dual_stop_flag:!1,
    is_stop: !1,
    is_wait: !1,
  ...
  getMessageSimulLayer: function () {
    return this.layer
      .getLayer(this.stat.simultaneous_layer, this.stat.simultaneous_page)
      .find(".message_inner");
  },
  ...
  setMessageSimulSpan: function () {
    var jtext = this.getMessageSimulLayer();
    0 == jtext.find("p").length && this.setNewParagraph(jtext);
    if (jtext.find("p").find(".current_span").length > 0) {
      jtext.find("p").find(".current_span").removeClass("current_span");
      this.stat.set_text_span = !1;
